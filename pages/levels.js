...
export default function Levels() {
  ...
  return (
    <MainBody>
      ...
      <h2>カードのレベルについて</h2>
      <p>
        本サイト、「SEIRYO GROUND | 清涼広場」にログインしたユーザー様はみんなデフォルトでSEIRYO GROUND メンバーシップカードをもらいます。ログインしているユーザー様は<a href="/profile">こちら</a>からアクセスできます。カードにはそれぞれ5段階のレベルがあり清涼広場に貢献する頻度と量によってカードのレベルが上がります。カードがアップグレードされるときのマイルストーンを記載させて頂きます：
      </p>
      <h3>マイルストーン</h3>
      <ul>
        <li>Level 1（白カード）：清涼広場にログインしたユーザー全て</li>
