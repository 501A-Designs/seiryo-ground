...
const loadSound = () => snd.play(Snd.SOUNDS.PROGRESS_LOOP)


export {buttonSound, sliderSound, tapSound,transitionUpSound,transitionDownSound, selectSound, swipeSound, typeSound,notificationSound,celebrationSound,loadSound};